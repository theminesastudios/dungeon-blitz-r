package
{
   ...
   public class LinkUpdater
   {
         ...
         if(_loc3_)
         {
            ...
            while(_loc7_ < EntType.MAX_SLOTS)
            {
               if(param1.method_11())
               {
                  ...
                  if(_loc5_)
                  {
                     _loc12_ = _loc11_ ? _loc11_.gearID : uint(0);
                     if(!_loc12_)
                     {
      ...
      private function method_1379(param1:Packet) : void
      {
         ...
         var _loc15_:uint = param1.method_11() ? param1.method_4() : uint(0);
         ...
         if(_loc30_)
         {
            ...
            while(_loc48_ < _loc47_)
            {
               ...
               else
               {
                  ...
                  _loc75_ = param1.method_11() ? param1.method_6(class_21.const_50) : uint(0);
                  if(_loc70_)
                  {
            ...
            while(_loc53_ <= _loc52_)
            {
               ...
               else if(param1.method_11())
               {
                  if(!param1.method_11())
                  {
                     _loc104_ = _loc101_.var_908 > 1 ? param1.method_4() : uint(0);
      ...
      private function method_1615(param1:Packet) : void
      {
         ...
         _loc29_ = param1.method_11() ? param1.method_4() : uint(0);
         _loc30_ = param1.method_11() ? param1.method_4() : uint(0);
