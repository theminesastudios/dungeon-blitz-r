...
const UPGRADE_TEXT = new Map<string, [string, string]>([
  ...
  ["DivineWord3", ["Increased Damage #olddmg#", "Adds a stack of Holy Fire. Increased Damage #olddmg#"]],
  ["Penance4", ["Increased Damage #olddmg#", "Adds Blind. Increased Damage #olddmg#"]],
  [
    "FountainOfLife4",
    ["Increased Damage #olddmg#. 460% Heal over 4 sec.", "Adds a stack of Holy Fire. 460% Heal over 4 sec."],
  ],
  [
    "FountainOfLife7",
    ["Increased Damage #olddmg#. 530% Heal over 4 sec.", "Faster cast animation. 530% Heal over 4 sec."],
  ],
  [
    "FountainOfLife10",
    ["Increased Damage #olddmg#. 600% Heal over 4 sec.", "-5 Mana Cost. 600% Heal over 4 sec."],
  ],
  ["CelestialLance6", ["Increased Holy Fire Damage", "The Lance now strikes every enemy around its target."]],
  ["CleavingBlows2", ["Increased Damage #olddmg#", "Your swings return 3 Mana each. Increased Damage #olddmg#"]],
  ["Verdict9", ["+30% Healing per shot", "Each shot returns 2 Mana."]],
  ["Verdict10", ["+50% Healing per shot", "+50% Healing per shot. +1.5 Second Duration."]],
  ["LeoneanAura10", ["Grants a 33% Attack and Expertise boost", "Grants a 33% Attack and Expertise boost for 8 seconds"]],
  [
    "LightningBomb1",
    [
      "Turns a foe into a Lightning Bomb causing them to explode when killed. Bomb effect spreads to one affected target.",
      "Stab a foe for heavy damage and 2 stacks of Armor Bane, turning them into a Lightning Bomb that explodes when killed. Bomb effect spreads to one affected target.",
    ],
  ],
]);
...
describeRanks(
  ...
  9,
  "Deals damage and Cripples enemies in AoE",
  "Deals damage, Cripples, Blinds and shreds the Armor of enemies in AoE",
);
describeRanks(
  "Subjugate",
  10,
...
describeRanks(
  ...
  "Grant your allies a small healing surge, Weaken your enemies in an AoE and set them alight with Holy Fire",
);
describeRanks(
  "Penance",
  4,
...
describeRanks(
  ...
  "Strike every foe around your target with an explosive lance, Staggering them and bathing the area in Holy Fire",
);
describeRanks(
  "CelestialLance",
  10,
  ...
  "Stun a foe and strike everything around them with an explosive lance, Staggering and bathing the area in Holy Fire",
);
describeRanks(
  "Sanctum",
  1,
  ...
  "Heals allies in an area, Blinds foes and sets them alight with Holy Fire",
);
describeRanks(
  "CleavingBlows",
  2,
  ...
  "For 5 seconds your basic melee attacks deal AoE damage, Ignite targets and return 3 Mana a swing.",
);
describeRanks(
  "LightningBomb",
  2,
  ...
  "Stab a foe for heavy damage and 2 stacks of Armor Bane, turning them into a Lightning Bomb that explodes when killed.",
);
...
// Empyrean Aura's sentence is generated from the durations above rather than written twice,
...
for (let rank = 1; rank <= 10; rank += 1) {
  ...
  DESCRIPTIONS.set(`LeoneanAura${rank}`, [
    ...
    `Attack and Expertise boost that lingers for ${seconds} seconds.`,
  ]);
}
