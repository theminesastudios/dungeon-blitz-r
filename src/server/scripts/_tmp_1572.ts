...
const methodIdx = methodIdxForTrait(traits, abc, "method_1572")!;
const body = abc.methodBodies.get(methodIdx)!;
const code = ctx.body.subarray(body.codeStart, body.codeStart + body.codeLen);
const insts = disassemble(code, "Buff.method_1572");
...
console.log(`Buff.method_1572: ${body.codeLen} bytes, ${insts.length} insts`);
