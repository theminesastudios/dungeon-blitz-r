...
const methodIdx = methodIdxForTrait(traits, abc, "method_1328")!;
const body = abc.methodBodies.get(methodIdx)!;
const code = ctx.body.subarray(body.codeStart, body.codeStart + body.codeLen);
const insts = disassemble(code, "BuffType.method_1328");
...
console.log(`BuffType.method_1328: ${body.codeLen} bytes, ${insts.length} insts`);
