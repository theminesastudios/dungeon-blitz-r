...
const var1176 = names.indexOf("var_1176");
console.log("var_1176 multiname:", var1176);
...
for (const o of owners) {
  ...
  for (const ins of insts) {
    if ((ins.opcode === 0x66 || ins.opcode === 0x61 || ins.opcode === 0x68) && ins.operands[0]?.[0] === "u30" && ins.operands[0][1] === var1176) {
